...
public class AreaListenerDemo {
    private static final Logger logger = LogManager.getLogger(AreaListenerDemo.class);
    ...
    public static class SimpleAreaListener implements AreaListener {
        private static final Logger logger = LogManager.getLogger(SimpleAreaListener.class);
