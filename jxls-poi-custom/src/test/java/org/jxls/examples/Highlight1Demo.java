...
public class Highlight1Demo {
    private static final Logger logger = LogManager.getLogger(Highlight1Demo.class);
    ...
    public static class HighlightCellAreaListener implements AreaListener {
        private static final Logger logger = LogManager.getLogger(HighlightCellAreaListener.class);
